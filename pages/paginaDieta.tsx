...
export function Dieta() {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.header}>Dicas de dieta e nutrição</Text>
      <View style={styles.form}>
        <Text style={styles.label}>Informe suas preferências:</Text>
        <TextInput
          placeholder="Você quer perder peso ou ganhar peso?"
          style={styles.input}
        />
        <TextInput
          placeholder="Deseja quantas refeições por dia?"
          style={styles.input}
        />
      </View>
      ...
      <ScrollView style={styles.containerScroll} showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 24, marginTop: 4 }}>
        ...
        <View style={styles.content}>
          <Text style={styles.title}>Sua recomendação de dieta:</Text>
